...
class _globals:
	_class_wide_params = ["InitialP0", "MassDensity"]
	_js_storage = None
	def js():
...
def _check(xobj):
	...
	#Make class-wide parameters visible
	for param_name in _globals._class_wide_params:
		xobj.getAttribute(param_name).visible = True
...
def makeXObjectMetaData():
	...
	for param_name in _globals._class_wide_params:
		attr = mka(param_name, 'Parameters', '',  MpcAttributeType.Real, dval=0.0)
		xom.addAttribute(attr)
